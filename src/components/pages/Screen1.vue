      ...
      <NucGroupElement top="0%" left="0%" v-bind:snapX="false" v-bind:snapY="false" bgColor="" position="absolute"
        ...
        <NucGroupElement top="12.684461805555555%" left="31.5625%" v-bind:snapX="false" v-bind:snapY="false" bgColor=""
          ...
          <WLabel top="9.060955518945635%" left="35.4066985645933%" text="TEAM COMODO" v-bind:snapX="false"
            ...
            v-bind:style="{'color':'#ffffff','width':'','height':'','zIndex':9,'fontSize':'30px','maxWidth':'','minWidth':'','fontStyle':'','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'bold','lineHeight':'1','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':''}"/>
          <WCircleImage top="5.107084019769357%" left="21.172248803827753%" v-bind:blank="false" v-bind:snapX="false"
            v-bind:snapY="false" rounded="circle" stretch="none"
            imageUrl="https://soft2u.ru/post-img/icon/comodo-antivirus-200x200.png" position="absolute"
            ...
            v-bind:style="{'width':'81px','height':'83px','zIndex':10,'maxWidth':'','minWidth':'','boxShadow':'','marginTop':'0px','maxHeight':'','minHeight':'','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','borderColor':'#4B74FF','borderStyle':'solid','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','borderTopWidth':'0px','borderLeftWidth':'0px','borderRightWidth':'0px','borderBottomWidth':'0px','borderTopLeftRadius':'0px','borderTopRightRadius':'0px','borderBottomLeftRadius':'0px','borderBottomRightRadius':'0px'}"/>
          <WLabel top="47.940691927512354%" left="23.086124401913874%" text="Release Tarihi: 28 Eylül"
